...
network_up_linker_file="/etc/network/if-up.d/linker"
...
uninstall_jobs(){
  ...
  # sudo rm -f $network_up_linker_file
}
install_jobs(){
  uninstall_jobs
  install_cronjobs
...
install_cronjobs(){
  ...
  declare -a cron_cmds=(
    ...
    # start_prod
    "@reboot $user sleep 2 \&\& $local_linker_service start_prod \> $folder_jobs_logs/start_prod \2\>\&\1" # ao iniciar device ligar servidor
    ...
    "\* 3 \* \* \* $user $local_linker_service reboot_device \> $folder_jobs_logs/reboot_device \2\>\&\1" # de madrugada reboot_device
...
# install_network_up_jobs(){
#   sudo touch $network_up_linker_file
...
#     # criar pasta
#     "mkdir -p $folder_jobs_logs"

#     # update_service
#     "sleep 2 \&\& bash -c \'$web_linker_service \| bash -s update_service\' \> $folder_jobs_logs/update_service"

#     # update_firmware
#     "sleep 2 \&\& bash -c \'$web_linker_service \| bash -s update_firmware\' \> $folder_jobs_logs/update_firmware"

#     # install_jobs
#     "sleep 2 \&\& bash -c \'$web_linker_service \| bash -s install_jobs\' \> $folder_jobs_logs/install_jobs"


#   )

#   for cmd in "${net_cmds[@]}"; do
#     sudo -- bash -c "echo $cmd >> $network_up_linker_file"
#   done

#   sudo chmod +x $network_up_linker_file

#   echo "Instalado network up jobs"
# }
...
install_firmware(){
  ...
  echo "  https://www.teamviewer.com/pt-br/download/raspberry-pi/"
